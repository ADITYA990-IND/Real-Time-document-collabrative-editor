...
import { io } from "socket.io-client"; // 1. Import ensure karo

// 2. Yahan add karo (Function ke bahar)
const backendUrl = import.meta.env.VITE_BACKEND_URL; 
const socket = io(https://real-time-collaborative-document-editor-ncw5.onrender.com);
...
function App() {
  ...
  const copyShareLink = () => {
    ...
    // Universal clipboard function with fallback for older browsers
